...
void monster_move::startMoving() {
    // 假设monster的起始位置已经在 (135, 135)
    // 创建一个动作序列，按路径点依次移动

    auto move1 = MoveBy::create(2, Vec2(180, 0));   // 从(135,135)到(315,135)
    auto move2 = MoveBy::create(4, Vec2(0, 370));   // 从(315,135)到(315,505)
    auto move3 = MoveBy::create(6, Vec2(540, 0));   // 从(315,505)到(855,505)
    auto move4 = MoveBy::create(4, Vec2(0, -370));  // 从(855,505)到(855,135)
    auto move5 = MoveBy::create(2, Vec2(190, 0));   // 从(855,135)到(1045,135)
